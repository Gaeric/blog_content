...
*** package-list
    ...
    2. thunar gvfs tumbler thunar-volman thunar-archive-plugin thunar-media-tags-plugin ntfs-3g meld
    3. zsh lua python3 clash firefox fzf zsh-autosuggestions zsh-syntax-highlighting
    4. emacs xorg-xwayland
    5. zathura zathura-cb zathura-djvu zathura-pdf-mupdf zathura-ps libreoffice-fresh
    6. wqy-microhei adobe-source-han-sans-cn-fonts
    7. ristretto mako linuxqq mpv gnome-system-monitor
